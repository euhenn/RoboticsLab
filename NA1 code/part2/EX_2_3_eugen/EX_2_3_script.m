...
%reorentation  (0:no translation, 1:translation) 

%2.1.1
test_cases(1) = struct('diff_flatness', 0, 'reorientation', 0, ...
                       'q_i', [-1, -1, pi/2], 'q_f', [1, 1, pi/2], ...
                       'k_i', 10, 'k_f', 10);
%2.1.1 different k                  
test_cases(2) = struct('diff_flatness', 0, 'reorientation', 0, ...
                       'q_i', [-1, -1, pi/2], 'q_f', [1, 1, pi/2], ...
                       'k_i', 15, 'k_f', 5);
%2.1.2 + re-orientation
test_cases(3) = struct('diff_flatness', 0, 'reorientation', 0, ...
                       'q_i', [-1, -1, pi/2], 'q_f', [1, 1, -pi/2], ...
                       'k_i', 11, 'k_f', 10);
%2.1.2 different k + re-orientation
test_cases(4) = struct('diff_flatness', 0, 'reorientation', 0, ...
                       'q_i', [-1, -1, pi/2], 'q_f', [1, 1, -pi/2], ...
                       'k_i', 15, 'k_f', 5);
%2.2.1
test_cases(5) = struct('diff_flatness', 1, 'reorientation', 0, ...
                       'q_i', [0, 0, -pi/3], 'q_f', [1, 1, pi/3], ...
                       'k_i', 10, 'k_f', 10);
%2.2.2                  
test_cases(6) = struct('diff_flatness', 1, 'reorientation', 0, ...
                       'q_i', [0, 0, 5*pi/3], 'q_f', [1, 1, pi/3], ...
                       'k_i', 10, 'k_f', 10);
%2.2.3
test_cases(7) = struct('diff_flatness', 1, 'reorientation', 0, ...
                       'q_i', [1, 1, -pi/3], 'q_f', [2, 2, pi/3], ...
                       'k_i', 10, 'k_f', 10);
%2.2.4 + re-orientation
test_cases(8) = struct('diff_flatness', 1, 'reorientation', 0, ...
                       'q_i', [1, 1, -pi/3], 'q_f', [1, 1, pi/3], ...
                       'k_i', 10, 'k_f', 10);
%2.2.5 translation
test_cases(9) = struct('diff_flatness', 1, 'reorientation', 1, ...
                       'q_i', [1, 1, -pi/3], 'q_f', [2, 2, pi/3], ...
                       'k_i', 10, 'k_f', 10);
%2.2.5 translation + re-orientation
test_cases(10) = struct('diff_flatness', 1, 'reorientation', 1, ...
                       'q_i', [1, 1, -pi/3], 'q_f', [1, 1, pi/3], ...
                       'k_i', 10, 'k_f', 10);
...
for i = 1:length(test_cases)
    ...
    reorientation = test_cases(i).reorientation;
